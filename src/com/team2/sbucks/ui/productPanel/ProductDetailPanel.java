...
public class ProductDetailPanel extends JPanel {
	...
	public ProductDetailPanel() {
		...
		lblNewLabel_5.setBounds(43, 240, 57, 15);
		add(lblNewLabel_5);
		
		textField_4 = new JTextField();
		textField_4.setBounds(157, 237, 116, 21);
		add(textField_4);
		textField_4.setColumns(10);
		
		JLabel lblNewLabel_6 = new JLabel("영양정보");
		lblNewLabel_6.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		lblNewLabel_6.setBounds(12, 294, 85, 30);
		add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("New label");
		lblNewLabel_7.setBounds(43, 351, 57, 15);
		add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("New label");
		lblNewLabel_8.setBounds(43, 389, 57, 15);
		add(lblNewLabel_8);
		
		JLabel lblNewLabel_9 = new JLabel("New label");
		lblNewLabel_9.setBounds(43, 431, 57, 15);
		add(lblNewLabel_9);
		
		textField_5 = new JTextField();
		textField_5.setBounds(157, 348, 116, 21);
		add(textField_5);
		textField_5.setColumns(10);
		
		textField_6 = new JTextField();
		textField_6.setBounds(157, 386, 116, 21);
		add(textField_6);
		textField_6.setColumns(10);
		
		textField_7 = new JTextField();
		textField_7.setBounds(157, 428, 116, 21);
		add(textField_7);
