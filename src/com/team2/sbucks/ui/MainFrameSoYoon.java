...
public class MainFrameSoYoon extends JFrame {
	...
	public MainFrameSoYoon() {
		...
		loginPanel loginPanel_ = new loginPanel();
		memberTabbedPane.addTab("New tab", null, loginPanel_, null);
