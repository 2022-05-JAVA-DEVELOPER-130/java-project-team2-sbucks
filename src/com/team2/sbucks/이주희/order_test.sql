...
insert into product values(1,'아메리카노',5000,'카페인','잠이안와요',0,0,700,500);
insert into product values(2,'카라멜 마끼야또',6000,'달콤해','너무달아요',0,0,700,500);
insert into product values(3,'자바 프라푸치노',7500,'짱맛있어요','너무비쌈',0,0,700,500);
insert into product values(4,'초콜릿 라떼',5500,'초콜릿','가나초콜릿',0,0,700,500);
insert into product values(5,'달고나 라떼',6500,'달달고나','달달해욧',0,0,700,500);
...
where member_no= 1 and product_no=1;
...
delete from orderlist where order_no=4;
--1번 회원 주문 내역
...
--주문 상황
/*
1번 회원이 1번 상품을 2개 장바구니에 담지 않고 곧바로 주문 
*/
insert into orderlist(order_no,order_date,member_no) 
values (orderList_order_no_SEQ.nextval,sysdate,1);
...
*/
insert into orderlist(order_no,order_date,member_no) 
values (orderList_order_no_SEQ.nextval,sysdate,2);
insert into orderdetail(orderdetail_no, order_no, order_stmt, product_no,order_qty)
values (ORDERDETAIL_ORDERDETAIL_NO_SEQ.nextval,orderList_order_no_SEQ.currval,1,1,1);
...
insert into orderdetail(orderdetail_no, order_no, order_stmt, product_no,order_qty)
values (ORDERDETAIL_ORDERDETAIL_NO_SEQ.nextval,orderList_order_no_SEQ.currval,1,3,5);
